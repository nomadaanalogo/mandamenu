...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#F5F2ED] text-gray-950 font-sans">
      ...
      {/* Nav */}
      <nav className="flex items-center justify-between px-5 md:px-8 py-5 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <a href="#registro"
            className="bg-gray-950 text-white text-sm font-semibold px-4 md:px-5 py-2 md:py-2.5 rounded-full hover:bg-gray-800 transition-colors">
            Empezar gratis
          </a>
        </div>
      </nav>
      ...
      {/* Hero */}
      <section className="px-5 md:px-8 pt-8 md:pt-10 pb-0 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-[1fr_420px] lg:grid-cols-[1fr_480px] gap-8 md:gap-10 items-end md:min-h-[88vh]">

          {/* Left: Copy */}
          <div className="flex flex-col justify-center gap-6 md:gap-8 pb-8 md:pb-20">
            ...
            <h1 className="font-black leading-[0.9] tracking-tighter text-[2.8rem] sm:text-[3.5rem] md:text-[clamp(3.5rem,8vw,7rem)]">
              Manda tu<br />
              menú,<br />
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4">
              <a href="#registro"
                className="inline-flex items-center gap-2 md:gap-3 bg-gray-950 hover:bg-gray-800 text-white font-bold px-6 md:px-8 py-3.5 md:py-4 rounded-full text-sm md:text-base transition-colors">
          ...
          <div className="relative self-end mt-4 md:mt-0">
            ...
            <div className="absolute -top-4 left-2 md:-top-6 md:-left-6 z-10 bg-white rounded-2xl shadow-2xl px-3 md:px-4 py-2.5 md:py-3 flex items-center gap-2 md:gap-3 border border-gray-100">
              <div className="w-8 h-8 md:w-9 md:h-9 bg-orange-500 rounded-xl flex items-center justify-center shrink-0">
            ...
            {/* QR badge */}
            <div className="absolute right-2 top-8 md:-right-3 md:top-10 z-10 bg-gray-950 rounded-2xl px-3 py-2.5 flex items-center gap-2">
              <QrCode size={14} strokeWidth={1.5} className="text-orange-500" />
              <span className="text-xs font-bold text-white">QR activo</span>
            </div>

            {/* App card */}
            <div className="bg-gray-950 rounded-t-3xl px-5 md:px-6 pt-12 md:pt-8 pb-0 overflow-hidden">
      ...
      {/* El problema */}
      <section className="bg-gray-950 text-white px-5 md:px-8 py-16 md:py-28">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            <p className="text-orange-500 text-sm font-semibold uppercase tracking-widest mb-5 md:mb-6">El problema</p>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black leading-tight tracking-tighter">
              La carta de<br />
              papel ya<br />
          ...
          <div className="flex flex-col gap-5 md:gap-6">
            {[
              ...
              <div key={i} className="flex items-start gap-4 border-b border-gray-800 pb-5 md:pb-6">
      ...
      {/* La solución */}
      <section className="px-5 md:px-8 py-16 md:py-28 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          <div className="md:sticky md:top-24">
            <p className="text-orange-500 text-sm font-semibold uppercase tracking-widest mb-5 md:mb-6">La solución</p>
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-black leading-tight tracking-tighter max-w-lg">
              Todo lo que<br />
              necesita tu<br />
      ...
      {/* Cómo funciona */}
      <section className="bg-white px-5 md:px-8 py-16 md:py-28 border-y border-gray-200">
        <div className="max-w-7xl mx-auto">
          <p className="text-orange-500 text-sm font-semibold uppercase tracking-widest mb-5 md:mb-6">Cómo funciona</p>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter mb-12 md:mb-20">
          ...
          <div className="grid sm:grid-cols-3 gap-8 md:gap-12">
            {[
              ...
              <div key={n} className="flex flex-col gap-3 md:gap-4">
                <span className="text-7xl md:text-8xl font-black text-gray-100 leading-none">{n}</span>
      ...
      {/* Para quién */}
      <section className="px-5 md:px-8 py-16 md:py-28 max-w-7xl mx-auto">
        <p className="text-orange-500 text-sm font-semibold uppercase tracking-widest mb-5 md:mb-6">Para quién es</p>
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter mb-10 md:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          {[
            ...
            <div key={type} className="bg-[#EDEAE4] rounded-3xl p-6 md:p-8">
      ...
      {/* Pricing CTA */}
      <section className="bg-orange-500 px-5 md:px-8 py-16 md:py-24">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-10">
          <div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tighter leading-tight">
              Desde $15 USD<br />al mes.
            </h2>
            <p className="text-orange-100 text-base md:text-lg mt-4">30 días gratis para empezar. Sin compromisos.</p>
          </div>
          <a href="#registro"
            className="w-full md:w-auto shrink-0 inline-flex items-center justify-center gap-3 bg-white text-orange-500 font-black px-8 md:px-10 py-4 md:py-5 rounded-full text-base md:text-lg hover:bg-orange-50 transition-colors">
      ...
      {/* Registro */}
      <section id="registro" className="px-5 md:px-8 py-16 md:py-28 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          <div>
            <p className="text-orange-500 text-sm font-semibold uppercase tracking-widest mb-5 md:mb-6">Empieza hoy</p>
            ...
            <ul className="flex flex-col gap-3 mt-6 md:mt-8">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 px-5 md:px-8 py-8 md:py-10">
